...
$BF build src/kernel/Kernel.cs src/kernel/Syscall.cs src/arch/Arch.cs src/arch/x86_64/IDT.cs src/arch/x86_64/ISR.cs src/kernel/RTC.cs src/arch/x86_64/PCI.cs src/kernel/Heap.cs src/kernel/Thread.cs src/kernel/IPC.cs src/arch/x86_64/KeyboardDriver.cs src/kernel/LibC.cs src/arch/x86_64/VMM.cs src/arch/x86_64/ContextLayout.cs src/boot/BootContract.cs src/arch/x86_64/PlatformBootstrap.cs src/kernel/Terminal.cs src/kernel/PMM.cs src/kernel/IO.cs src/arch/x86_64/PIC.cs src/arch/x86_64/PIT.cs src/arch/x86_64/InterruptHandlers.cs src/kernel/ATA.cs src/kernel/FAT16.cs src/kernel/GlobalUsings.cs src/kernel/System.Runtime.InteropServices.cs src/kernel/System.Runtime.CompilerServices.cs src/kernel/PELoader.cs src/kernel/StrandScheduler.cs src/arch/x86_64/GDT.cs src/kernel/PRNG.cs src/arch/x86_64/Power.cs src/arch/x86_64/APIC.cs src/arch/x86_64/SMP.cs src/kernel/Spinlock.cs src/arch/x86_64/IOAPIC.cs src/arch/x86_64/vDSO.cs src/arch/x86_64/HardwareChecks.cs src/arch/x86_64/Serial.cs src/arch/x86_64/MouseDriver.cs src/kernel/NekkoInt.cs src/kernel/KernCrypto.cs -Ot --no-pie --deterministic --map maps/Kernel.map --os windows --arch x64 --stdlib zero -o Kernel.exe --ldflags "-export:KernelMain Hardware.obj build/libc.o build/prng.o build/kerncrypto.o build/pmm.o build/heap.o build/strandscheduler.o build/ipc.o build/terminal.o build/arch_interface.o build/interrupt_impl.o build/timer_impl.o build/mmu_impl.o build/platform_impl.o build/rtc.o"
