...
$BF build src/Kernel.cs src/Syscall.cs src/IDT.cs src/ISR.cs src/RTC.cs src/PCI.cs src/Heap.cs src/Thread.cs src/IPC.cs src/KeyboardDriver.cs src/LibC.cs src/VMM.cs src/Terminal.cs src/PMM.cs src/IO.cs src/PIC.cs src/PIT.cs src/InterruptHandlers.cs src/ATA.cs src/FAT16.cs src/GlobalUsings.cs src/System.Runtime.InteropServices.cs src/System.Runtime.CompilerServices.cs src/PELoader.cs src/StrandScheduler.cs src/GDT.cs src/PRNG.cs src/Power.cs src/APIC.cs src/SMP.cs src/Spinlock.cs src/IOAPIC.cs src/vDSO.cs src/Serial.cs src/MouseDriver.cs src/NekkoInt.cs src/KernCrypto.cs -Ot --no-pie --deterministic --map maps/Kernel.map --os windows --arch x64 --stdlib zero -o Kernel.exe --ldflags "-export:KernelMain Hardware.obj build/libc.o build/prng.o build/kerncrypto.o build/pmm.o build/heap.o"
