...
{
    public static void Out32(ushort port, uint value) => Arch.WritePort32(port, value);
    public static uint In32(ushort port) => Arch.ReadPort32(port);
    private static void FullFence() => Arch.FullFence();
