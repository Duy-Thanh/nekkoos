...
// =========================================================================
// MODULE: HardwareChecks - chuỗi kiểm tra/anti-tamper phần cứng lúc boot.
// ARCH: x86_64 ONLY (poll 8042, port 0x80 delay, IPI APIC, Cli/Hlt).
// Kernel generic chỉ gọi HardwareChecks.CheckHardwareError().
// =========================================================================
...
public static unsafe class HardwareChecks
{
    // [ARCH x86_64] Offset TSC do kernel hiệu chuẩn - ghi qua APIC/IPI trong chuỗi kiểm tra
    public static ulong HardwareTscOffset = 0;

    [DllImport("*", EntryPoint = "Arch_CompilerFence")] private static extern void CompilerFence();

    // fw_cfg (QEMU virtual platform interface): quét danh mục entry theo tên
